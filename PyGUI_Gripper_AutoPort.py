...
portName="/dev/cu.usbmodem1301"
Aport="/dev/cu.usbmodem1301"
...
slider = customtkinter.CTkSlider(master=app, from_=0, to=120, command=slider_event, width=480, height=32)
slider.set(0)
